...
st.set_page_config(page_title="Solvay LLM")
st.sidebar.title("SolvayLLM - DROI-S3001: Labour Law")
st.sidebar.divider()
st.sidebar.markdown("Projet en cours de développement", unsafe_allow_html=True)
